...
using TicketService.API.Middlewares;
...
app.Urls.Add(Environment.GetEnvironmentVariable("TICKET_SERVICE_URL") ?? 
             builder.Configuration["Service:Url"] ?? "http://localhost:5005");
